...
parser.add_argument('from_', type=int, nargs=1, help='the starting problem id, inclusive', metavar='from')
parser.add_argument('to', type=int, nargs=1, help='the ending problem id, inclusive')
try:
...
try:
    ...
    prange = range(args.from_[0], args.to[0] + 1)
